        ...
        <el-card class="!border-none" shadow="never">
            <el-form class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item label="是否需要配送">
                    <el-select v-model="queryParams.need_delivery" class="w-[130px]" clearable placeholder="全部">
                        <el-option label="需要配送" :value="1" />
                        <el-option label="无需配送" :value="0" />
                    </el-select>
                </el-form-item>
                <el-form-item label="楼栋">
                    <el-select v-model="queryParams.building" class="w-[170px]" clearable placeholder="全部楼栋">
...
import { dispatchOrder, getMealOrderList } from '@/mock/api'
