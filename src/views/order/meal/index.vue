<template>
    <div class="order-meal" v-loading="pager.loading">
        <el-card class="!border-none" shadow="never">
            <template #header>
                <div class="flex items-center justify-between">
                    <span class="card-title">送餐服务订单</span>
            ...
            <el-table :data="filteredList" stripe>
                ...
                <el-table-column prop="service" label="餐品内容" min-width="130" show-overflow-tooltip />
                <el-table-column label="配送员工" width="100">
        ...
        <el-dialog v-model="showDispatch" title="订单派单" width="420px">
            <el-form label-width="90px">
                ...
                <el-form-item label="餐品内容">
                    <span>{{ dispatchRow?.service }}</span>
                </el-form-item>
                <el-form-item label="指派员工" required>
                    <el-select v-model="dispatchStaffId" placeholder="请选择配送员" class="!w-full">
        ...
        <el-dialog v-model="showDetail" title="订单详情" width="460px">
            <el-descriptions :column="1" border v-if="detailRow">
                ...
                <el-descriptions-item label="餐品内容">{{ detailRow.service }}</el-descriptions-item>
...
import { getMealOrderList } from '@/mock/api'
import { usePaging } from '@/hooks/usePaging'
import { Search } from '@element-plus/icons-vue'
import { staffList } from '@/mock/data'

const { pager, getLists } = usePaging({ fetchFun: getMealOrderList, firstLoading: true })
