<template>
    <div class="order-nursing" v-loading="pager.loading">
        <el-card class="!border-none" shadow="never">
            <template #header>
                <div class="flex items-center justify-between">
                    <span class="card-title">养老服务订单</span>
...
const { pager, getLists } = usePaging({ fetchFun: getNursingOrderList, firstLoading: true })
