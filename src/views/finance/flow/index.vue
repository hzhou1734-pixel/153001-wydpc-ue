    ...
    <div class="finance-flow">
        <el-card class="!border-none" shadow="never">
            ...
            <el-form :model="queryParams" inline class="mb--4">
                <el-form-item label="支付方式">
                    <el-select v-model="queryParams.pay_type" placeholder="请选择" clearable class="!w-[130px]">
        ...
        <el-card class="!border-none mt-4" shadow="never" v-loading="pager.loading">
            <el-table :data="pager.lists" stripe>
                ...
                <el-table-column prop="service" label="服务名称" min-width="150" show-overflow-tooltip />
                <el-table-column label="支付用户头像" min-width="80" align="center">
                    <template #default="{ row }">
                ...
                <el-table-column label="支付金额" min-width="110" align="right">
                    <template #default="{ row }">
