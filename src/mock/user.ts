    ...
    // ============ ⑤ 服务管理 ============
    {
        ...
        children: [
            ...
            },
            {
                name: '生活帮手',
                paths: 'helper',
                component: 'service/helper/index',
                perms: 'service.helper/lists',
                type: 'C',
                is_show: 1,
                is_cache: 0,
            },
    ...
    // ============ ⑥ 订单管理 ============
    {
        ...
        children: [
            ...
            },
            {
                name: '生活帮手订单',
                paths: 'helper',
                component: 'order/helper/index',
                perms: 'order.helper/lists',
                type: 'C',
                is_show: 1,
                is_cache: 0,
            },
            {
                name: '订单评价',
                paths: 'evaluate',
                component: 'order/evaluate/index',
                perms: 'order.evaluate/lists',
                type: 'C',
                is_show: 1,
                is_cache: 0,
            },
    ...
    // ============ ⑦ 内容管理 ============
    {
        ...
        children: [
            ...
            },
            {
                name: '人才库',
                paths: 'talent',
                component: 'article/talent/index',
                perms: 'article.talent/lists',
                type: 'C',
                is_show: 1,
                is_cache: 0,
            },
    ...
    // ============ ⑧ 财务管理 ============
    {
        ...
        children: [
            ...
            },
            {
                name: '小区钱袋子',
                paths: 'wallet',
                component: 'finance/wallet/index',
                perms: 'finance.wallet/lists',
                type: 'C',
                is_show: 1,
                is_cache: 0,
            },
            {
                name: '收益配置',
                paths: 'profit',
                component: 'finance/profit/index',
                perms: 'finance.profit/lists',
                type: 'C',
                is_show: 1,
                is_cache: 0,
            },
