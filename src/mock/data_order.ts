...
export const orderEvaluations = [
    { id: 5001, status: 1, sn: 'TG20260908001', title: '日托·9月第一期', avatar: userImg(1), nickname: '张伟', mobile: '13812341001', stars: 5, content: '托管员每天早上准时上门接孩子，晚上还贴心反馈饮食和作息情况，非常省心，强烈推荐！', create_time: daysAgo(0, ' 19:20:00') },
    { id: 5002, status: 1, sn: 'SC20260907002', title: '双荤商务午餐组合', avatar: userImg(2), nickname: '李娜', mobile: '13812341002', stars: 5, content: '配送很快，保温盒包装很严实，打开还是热乎的，分量也足。', create_time: daysAgo(1, ' 12:35:00') },
    { id: 5003, status: 1, sn: 'PZ20260907002', title: '普通门诊陪诊（时价）', avatar: userImg(1), nickname: '张伟', mobile: '13812341001', stars: 4, content: '陪诊员全程帮忙排队挂号取药，服务态度很好，就是医院车位太紧张耽误了点时间。', create_time: daysAgo(1, ' 15:48:00') },
    { id: 5004, status: 1, sn: 'BZ20260907002', title: '管道疏通', avatar: userImg(2), nickname: '李娜', mobile: '13812341002', stars: 5, content: '师傅上门很快，十几分钟就疏通好了，还顺手清理了现场，价格也公道。', create_time: daysAgo(1, ' 15:20:00') },
    { id: 5005, status: 1, sn: 'SC20260906003', title: '清淡养身晚餐组合', avatar: userImg(4), nickname: '赵敏', mobile: '13812341004', stars: 3, content: '粥和小菜都挺好，就是配送比约定时间晚了近二十分钟，希望能改进。', create_time: daysAgo(2, ' 19:05:00') },
    { id: 5006, status: 1, sn: 'TG20260906003', title: '学期每日托·2026秋季', avatar: userImg(5), nickname: '陈晨', mobile: '13812341005', stars: 5, content: '一整个学期的托管都交给社区了，老师很负责，孩子作业在学校就写完了。', create_time: daysAgo(2, ' 20:30:00') },
    { id: 5007, status: 1, sn: 'BZ20260906004', title: '开锁换锁', avatar: userImg(5), nickname: '陈晨', mobile: '13812341005', stars: 5, content: '晚上十点多求助，师傅四十分钟就到了，收费透明没有额外加价，太感谢了。', create_time: daysAgo(2, ' 21:40:00') },
    { id: 5008, status: 1, sn: 'PZ20260905004', title: '住院陪护（时价）', avatar: userImg(3), nickname: '王强', mobile: '13812341003', stars: 4, content: '陪护护士照顾得细致，夜间也会定时查看，唯一遗憾是不能连续同一位陪诊员。', create_time: daysAgo(3, ' 11:15:00') },
    { id: 5009, status: 1, sn: 'BZ20260905005', title: '居家照护', avatar: userImg(6), nickname: '刘洋', mobile: '13812341006', stars: 5, content: '老人术后行动不便，照护人员很有耐心，还会帮忙做康复按摩，家人放心不少。', create_time: daysAgo(3, ' 18:25:00') },
    { id: 5010, status: 0, sn: 'SC20260904005', title: '低糖轻食组合', avatar: userImg(6), nickname: '刘洋', mobile: '13812341006', stars: 2, content: '到食堂自取时只剩一份，套餐内容和APP上介绍的不太一致，希望库存能准一点。', create_time: daysAgo(4, ' 12:10:00') },
    { id: 5011, status: 1, sn: 'BZ20260902008', title: '搬家搬运', avatar: userImg(5), nickname: '陈晨', mobile: '13812341005', stars: 5, content: '钢琴包装得很专业，全程没有磕碰，师傅们搬完还帮着把垃圾清理了，好评。', create_time: daysAgo(6, ' 19:50:00') },
    { id: 5012, status: 0, sn: 'TG20260901008', title: '学期周末托·周日班', avatar: userImg(2), nickname: '李娜', mobile: '13812341002', stars: 1, content: '临时有事申请退款，客服处理了很久才开始退，希望以后能更顺畅一些。', create_time: daysAgo(7, ' 10:05:00') }
]
